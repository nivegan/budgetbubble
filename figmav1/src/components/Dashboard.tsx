  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        {/* Net Worth */}
        <Card className="bg-[#3d5a80] border-[#577189] col-span-1 md:col-span-2 lg:col-span-4">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-[#c1d3e0]">Net Worth</CardTitle>
            <DollarSign className="h-4 w-4 text-[#c1d3e0]" />
          </CardHeader>
          <CardContent>
            <div className="text-4xl font-bold text-[#69d2bb]">{formatCurrency(stats.netWorth)}</div>
            <p className="text-xs text-[#a7b8c5] mt-2">Total Cash + Total Holdings</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-[#3d5a80] border-[#577189]">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-[#c1d3e0]">Total Cash</CardTitle>
            <Wallet className="h-4 w-4 text-[#c1d3e0]" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-white">{formatCurrency(stats.totalCash)}</div>
            <p className="text-xs text-[#a7b8c5] mt-2">Based on all transactions</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-[#3d5a80] border-[#577189]">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-[#c1d3e0]">Total Holdings</CardTitle>
            <TrendingUp className="h-4 w-4 text-[#c1d3e0]" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-white">{formatCurrency(stats.totalHoldings)}</div>
            <p className="text-xs text-[#a7b8c5] mt-2">{isPersonalView ? "Your personal assets" : "Household assets"}</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-[#3d5a80] border-[#577189]">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-[#c1d3e0]">Available to Assign</CardTitle>
            <Wallet className="h-4 w-4 text-[#c1d3e0]" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-white">{formatCurrency(stats.availableToAssign)}</div>
            <p className="text-xs text-[#a7b8c5] mt-2">
        ...
        <Card className="bg-[#3d5a80] border-[#577189]">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-[#c1d3e0]">Total in Pockets</CardTitle>
            <Target className="h-4 w-4 text-[#c1d3e0]" />
          </CardHeader>
          <CardContent>
      ...
      <Card className="bg-[#3d5a80] border-[#577189]">
        <CardHeader>
          <CardTitle className="text-base font-medium text-[#c1d3e0]">Future Development</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="flex items-center justify-center h-48 text-[#a7b8c5]">
